...
Statisches Routing bedeutet, dass Routen manuell am Router eingetragen werden. Der Router lernt diese Wege nicht dynamisch, sondern verwendet exakt die konfigurierten Einträge.
...
\begin{itemize}
\item \textbf{Static Routing:} wenig Overhead, sehr kontrollierbar, aber mehr manueller Aufwand.
