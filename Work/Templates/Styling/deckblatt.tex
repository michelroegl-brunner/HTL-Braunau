...
\includegraphics[width=0.8\linewidth]{../../../Templates/Styling/htl_c_cmyk_rein.pdf}
\end{minipage}
...
\hfill \includegraphics[width=0.8\linewidth]{../../../Templates/Styling/htl-bildung-mit-zukunft.png}
\end{minipage}\\
}
